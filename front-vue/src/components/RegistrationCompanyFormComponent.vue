...
const handleRegister = async() => {
    try {
        ...
        router.push({ path: '/dashboardCompany', query: { fromRegistration: true } });
    ...
    <div v-if="step === 2" class="card shadow-sm mb-4">
      ...
      <div class="card-body">
        <form @submit.prevent="nextStep">
          ...
          <div class="mb-3">
            <label for="biography" class="form-label">Sobre tu empresa</label>
    ...
    <div v-if="step === 3" class="card shadow-sm mb-4">
      ...
      <div class="card-body">
        <form @submit.prevent="handleRegister">
          <div class="mb-3">
            <label for="photo" class="form-label">Foto de empresa</label>
            <input type="file" id="photo" class="form-control" @change="handleFileChange('photo', $event)" />
          </div>

          <div class="mb-3">
            <label for="cv" class="form-label">Carta coorpotaiva (PDF)</label>
